...
import com.foriba.jws2.dao.DAOGeneric;
...
public class DAOGenericBean<T extends BaseEntity> implements DAOGeneric<T> {
	...
	@SuppressWarnings("unchecked")
	@Override
	public <O> List<O> findByNamedQuery(Class<O> clazz, String namedQuery,
			int readSize, Object... params) throws Exception {
		return createNamedQuery(clazz, namedQuery, params).setMaxResults(
				readSize).getResultList();
	}

	@SuppressWarnings("unchecked")
	@Override
	public <O> O findByNamedQuerySingle(Class<O> clazz, String namedQuery,
			Object... params) throws Exception {
		return (O) createNamedQuery(clazz, namedQuery, params)
				.getSingleResult();
	}

	@SuppressWarnings("unchecked")
	@Override
	public <O> List<O> findByQuery(Class<O> clazz, String jpaQuery,
			int readSize, Object... params) throws Exception {
		return createDynamicQuery(clazz, jpaQuery, params).setMaxResults(
				readSize).getResultList();
	}

	@SuppressWarnings("unchecked")
	@Override
	public <O> O findByQuerySingle(Class<O> clazz, String jpaQuery,
			Object... params) throws Exception {
		return (O) createDynamicQuery(clazz, jpaQuery, params)
				.getSingleResult();
	}

	private Query createNamedQuery(Class<?> clazz, String namedQuery,
			Object... params) throws Exception {
	...
	private Query createDynamicQuery(Class<?> clazz, String jpaQuery,
			Object... params) throws Exception {
